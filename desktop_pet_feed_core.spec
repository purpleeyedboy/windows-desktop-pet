...
pyz=PYZ(a.pure)
exe=EXE(pyz,a.scripts,a.binaries,a.datas,[],name='桌面宠物_文件喂食与回收站事务修复',debug=False,bootloader_ignore_signals=False,strip=False,upx=True,console=False,version=str(ROOT/'version_info_feed_core.txt'))
