...
def test_source_metadata_identifies_baseline_features_beta_and_documentation() -> None:
    ...
    assert metadata["foundation_commit"] == "77a4f3a90c74c549a66052bebb4b652500e1f7be"
    assert metadata["enabled_features"] == ["既有基线", "耳朵防触摸系统"]
    ...
    for label in ("产品版本", "构建日期", "Git", "基础标签", "公共基础提交", "启用功能", "渠道", "文档基线"):
