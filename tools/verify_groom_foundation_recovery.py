...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="groom-foundation-") as directory:
        root = Path(directory)
        legacy = root / "legacy"
    ...
    print("Groom shared migration, backup, journal, log and shutdown recovery verification passed")
    return 0
