...
- 公共基础来自 `f617765b1aeb1be9cf9d73ce1dd04f5f4e426421`；逐帧活动与菜单优先级修复来自 `6af84461332787ee6eb16ffe945a56083bbd1d89`（包括 e361579 的活动播放修复），公共基础 PR #5 正式发布的活动恢复修复来源记录为 `77a4f3a90c74c549a66052bebb4b652500e1f7be`。本分支保留已有功能并以隔离回归验证恢复契约；`docs/hunger-foundation-provenance.json` 保存来源提交及逐文件真实 Git blob 与 SHA-256，构建前逐项核验。
